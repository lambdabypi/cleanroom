...
- Rows containing email addresses, phone numbers, or government identifiers are rejected by the validator before scoring.
- Every row carries the URL of the page it was read from.
